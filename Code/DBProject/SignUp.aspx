...
<head runat="server">
    ...
    <title>Pranam Health Care &amp; Register</title>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2 text">
                                ...
                                <h1><strong>Pranam Health Care</strong> <br/>
                                    
                                    Login &amp; Registration Form</h1>

                                <div class="description">
                                    <p>
                                        This is a free <strong>"Login and Registration form"</strong> for Health Care
                                        Clinic.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="form-box">
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="loginEmail" runat="server" type="text"
                                                class="form-username form-control" placeholder="Email"></asp:TextBox>

                                        </div>

                                        <div class="form-group">

                                            <asp:TextBox ID="loginPassword" runat="server" type="password"
                                                class="form-username form-control" placeholder="Password"></asp:TextBox>

                                        </div>

                                        <asp:button ID="loginUserName" runat="server" type="submit" Text="Login"
                                            class="btn btn-primary" OnClientClick="return validateL();"
                                            onclick="loginV"></asp:button>
                                ...
                                <div class="form-box">
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="sName" runat="server" type="text"
                                                class="form-username form-control" placeholder="Name"></asp:TextBox>

                                        </div>

                                        <div class="form-group">

                                            <asp:TextBox ID="sBirthDate" runat="server" type="text"
                                                class="form-username form-control"
                                                placeholder="Birth Date (dd-mm-yyyy)"></asp:TextBox>

                                        </div>

                                        <div class="form-group">

                                            <asp:TextBox ID="sEmail" runat="server" type="text"
                                                class="form-username form-control"
                                                placeholder="Email : person@example.com"></asp:TextBox>

                                        </div>

                                        <div class="form-group">

                                            <asp:TextBox ID="sPassword" runat="server" type="password"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="scPassword" runat="server" type="password"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="Phone" runat="server" type="text"
                                                class="form-username form-control"
                                                placeholder="Phone Number (11 Digits)"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox id="Address" placeholder="Address" TextMode="multiline"
                                                Columns="40" Rows="10" runat="server" Height="75px" Width="410px" />

                                        </div>

                                        <asp:button Text="SignUp" runat="server" type="submit" class="btn btn-primary"
                                            OnClientClick="return validateS();" onclick="signupV"></asp:button>
