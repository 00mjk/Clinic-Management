...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div
        style="background-image:url(/assets/image/background/PatientBackground.jpg); background-position:center; background-size:20px">
        ...
        <div style="margin-left: 70px">
            ...
            <asp:Button ID="AppointmentB" runat="server" Text="Take Appointment" OnClick="RedirectToAppointmentTaker"
                Font-Bold="true" />
