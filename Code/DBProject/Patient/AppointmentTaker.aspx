...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="PAppointmentGrid" runat="server" class="GridView-d" CellPadding="4" ForeColor="Black"
        GridLines="Vertical" Width="800px" AutoGenerateSelectButton="true" OnRowCommand="PAppointmentGrid_RowCommand"
        AutoGenerateColumns="true" EnableViewState="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None"
        BorderWidth="1px">
