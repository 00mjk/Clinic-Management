...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="BHistory" style="margin-left: 550px;" runat="server"></asp:Label>
    <br /><br />

    <asp:GridView ID="BHistoryGrid" runat="server" class="GridView-d" CellPadding="4" ForeColor="Black"
        GridLines="Vertical" Width="800px" EnableViewState="False" BackColor="White" BorderColor="#DEDFDE"
